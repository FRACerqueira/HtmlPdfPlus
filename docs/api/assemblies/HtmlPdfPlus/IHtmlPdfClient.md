...
| [FromUrl](IHtmlPdfClient/FromUrl.md)(…) | Register Page Url to be executed by the server. Sent with an explicit Url, subject to the server's configured URL allow-policy before navigation. |
