...
namespace ConsoleHtmlToPdfPlus.OnlyAtServerQuickStart
{
    public class Program
    {
        ...
        {
            Console.WriteLine("Example: minimal server-only conversion - default byte[] output, FromHtml and FromUrl render modes, no hooks");
            Console.WriteLine("==============================================================================================================");
